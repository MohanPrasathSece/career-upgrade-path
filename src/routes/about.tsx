...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://careerupgradedentalnursingschool.co.uk/about" },
    ...
    links: [{ rel: "canonical", href: "https://careerupgradedentalnursingschool.co.uk/about" }],
  }),
  component: About,
});
...
const support = [
  {
    ...
    desc: "Subject experts available throughout your training.",
  },
  {
    icon: ClipboardCheck,
    title: "Assessor Guidance",
    desc: "Workplace assessors guide your portfolio and observations.",
  },
  {
    icon: MessageSquare,
    title: "Friendly Customer Service",
    desc: "Real humans, fast replies - by phone, email or WhatsApp.",
  },
  {
    icon: CalendarRange,
    title: "Flexible Learning Schedule",
    desc: "Study around shifts, family or other commitments.",
  },
  {
    icon: HandHeart,
    title: "One-to-One Assistance",
    desc: "Personalised coaching whenever you need it.",
  },
  {
    icon: ShieldCheck,
    title: "Wellbeing First",
    desc: "Mental health and study-life balance built into our approach.",
  },
];
...
const steps = [
  { title: "Apply Online", desc: "A simple 5-minute application - no upfront commitment." },
  {
    ...
    desc: "Free consultation about funding, start dates and goals.",
  },
          ...
          {[
            {
              icon: Target,
              label: "Our Mission",
              title: "Open dental nursing to everyone in the UK",
              desc: "Remove barriers to qualifying - through flexible delivery, transparent costs and human support that doesn't disappear after enrolment.",
            },
            {
              icon: Compass,
              label: "Our Vision",
              title: "The most trusted online dental training in the UK",
              desc: "A future where qualified dental nurses come from every background and every postcode - equipped with confidence and modern skills.",
            },
          ].map((c) => (
            <div
              key={c.label}
              className="rounded-3xl border border-border bg-card p-8 shadow-soft transition hover:shadow-card hover:-translate-y-1 md:p-10"
            >
      ...
      <Section>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {support.map((s) => (
            <div
              key={s.title}
              className="rounded-2xl border border-border bg-card p-7 shadow-soft transition hover:-translate-y-1 hover:shadow-card hover:border-primary/40"
            >
      ...
      <Section>
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <Link
              to="/contact"
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-gradient-primary px-7 py-3.5 text-sm font-semibold text-primary-foreground shadow-soft hover:shadow-glow hover:-translate-y-0.5 transition"
            >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div
                key={s.l}
                className="rounded-2xl border border-border bg-card p-6 shadow-soft text-center"
              >
