...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-[5.5rem] right-6 z-50 grid h-12 w-12 place-items-center rounded-full bg-[#25D366] text-white shadow-glow transition hover:scale-110 active:scale-95"
    >
