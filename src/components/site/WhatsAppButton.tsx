...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-22 right-6 z-50 grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-white shadow-glow transition hover:scale-110 active:scale-95"
    >
